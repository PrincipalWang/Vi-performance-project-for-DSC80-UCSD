...
| league   | ban1    | ban2    | ... | pick4        | pick5   |   result |   firstblood |   dragons |   firstherald |   firsttower |   firstbaron |
|:---------|:--------|:--------|:----|:-------------|:--------|---------:|-------------:|----------:|--------------:|-------------:|-------------:|
| LPL      | Senna   | Orianna | ... | Renata Glasc | Vex     |        0 |            0 |         1 |           nan |          nan |          nan |
| LPL      | Nidalee | Kindred | ... | Ahri         | Rell    |        1 |            1 |         4 |           nan |          nan |          nan |
| LPL      | Nidalee | Kindred | ... | Zoe          | Kayle   |        0 |            0 |         1 |           nan |          nan |          nan |
| LPL      | Gwen    | Lucian  | ... | Taliyah      | Riven   |        1 |            1 |         4 |           nan |          nan |          nan |
| LPL      | Senna   | Gwen    | ... | Swain        | Gnar    |        0 |            0 |         3 |           nan |          nan |          nan |
