...
| league   | ban1    | ... | pick5   |   result |   firstblood |   dragons |   firstherald |   firsttower |   firstbaron |
|:---------|:--------|:----|:--------|---------:|-------------:|----------:|--------------:|-------------:|-------------:|
| LPL      | Senna   | ... | Vex     |        0 |            0 |         1 |           nan |          nan |          nan |
| LPL      | Nidalee | ... | Rell    |        1 |            1 |         4 |           nan |          nan |          nan |
| LPL      | Nidalee | ... | Kayle   |        0 |            0 |         1 |           nan |          nan |          nan |
| LPL      | Gwen    | ... | Riven   |        1 |            1 |         4 |           nan |          nan |          nan |
| LPL      | Senna   | ... | Gnar    |        0 |            0 |         3 |           nan |          nan |          nan |
